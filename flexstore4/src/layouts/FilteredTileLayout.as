package layouts
{
	...
	public class FilteredTileLayout extends LayoutBase
	{
		...
		{
			//NOTE: Prevent updateDisplayList() from being executed while we are animating tiles
		...
		override public function updateDisplayList(containerWidth:Number, containerHeight:Number):void
		{
			...
			var count:int = target.numElements;//count will not change when filter change
			if (count == 0) return;
