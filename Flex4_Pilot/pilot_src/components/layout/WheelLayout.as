...
/**
 * origin from Evtim http://evtimmy.com/2010/04/two-examples-of-layout-animations/
 */
...
public class WheelLayout extends LayoutBase
{
    ...
    override public function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
    {
        ...
        { 
            ...
            m.appendTranslation(-elementWidth/2, -elementHeight/2 + radius * _axis.z + verticalCenterOffset, -radius * _axis.y );
    ...
    private var _verticalCenterOffset:Number = 0;
    public function set verticalCenterOffset(value:Number):void
    {
        _verticalCenterOffset = value;
        if (target)
            target.invalidateDisplayList();
    }
    
    public function get verticalCenterOffset():Number
    {
        return this._verticalCenterOffset;
    }
